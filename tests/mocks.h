...
class MockMicroCore : public wtipeg::MicroCore
{
public:
...
class MockRPCCalls : public wtipeg::RPCCalls
{
public:
    MockRPCCalls(string _deamon_url)
        : wtipeg::RPCCalls(_deamon_url)
    {}
...
class MockTxSearch : public wtipeg::TxSearch
{
public:
    ...
    MOCK_METHOD0(get_known_outputs_keys,
                 wtipeg::TxSearch::known_outputs_t());

    MOCK_CONST_METHOD0(get_wtip_address_viewkey,
                 wtipeg::TxSearch::addr_view_t());
    ...
    MOCK_METHOD2(mock_find_txs_in_mempool,
                 void(wtipeg::TxSearch::pool_txs_t mempool_txs,
...
class MockCurrentBlockchainStatus : public wtipeg::CurrentBlockchainStatus
{
public:
    MockCurrentBlockchainStatus()
        : wtipeg::CurrentBlockchainStatus(wtipeg::BlockchainSetup(),
                                         nullptr, nullptr)
    {}
