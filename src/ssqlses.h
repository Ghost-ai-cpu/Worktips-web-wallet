...
#ifndef RESTBED_WTIP_SSQLSES_H
#define RESTBED_WTIP_SSQLSES_H
...
struct WtipAccount : public Accounts, Table
{
...
struct WtipTransaction : public Transactions, Table
{
    ...
    static constexpr const char* SUM_WTIP_RECIEVED = R"(
...
struct WtipOutput : public Outputs, Table
{
...
struct WtipInput : public Inputs, Table
{
...
struct WtipPayment : public Payments, Table
{
